    ...
    if (u8g2.getMenuEvent() == FUNC) {
      ...
      switch (item_num) {
        case 0:
          ...
          break;
        case 1: p_t_accel = setupProgTime(p_t_accel, 3); break;
        case 2: p_vel = setupProgNumbers(p_vel, 4); break;
        case 3: p_t_work = setupProgTime(p_t_work, 5); break;
        case 4: p_t_decel = setupProgTime(p_t_decel, 6); break;
        case 5: p_t_pause = setupProgTime(p_t_pause, 7); break;
      }
    }
